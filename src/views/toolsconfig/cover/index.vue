      ...
      <el-col :span="10">
        <div class="grid-content bg-purple">
          <el-form ref="form" :model="form" label-width="180px">
            ...
            <el-form-item label="第二次买入股票数(整百)">
              <el-input-number v-model="form.secNumber" :step="100" :min="100" step-strictly />
            </el-form-item>

            <el-form-item label="(>=)准备买入后的价格:">
              <el-col :span="12"><el-input v-model="form.secPrice"/></el-col>
              <el-col :span="6" :offset="6"><el-button type="success" @click="calcMakePrice()">预计买入计算</el-button></el-col
              >
            </el-form-item>
      ...
      <el-col :span="12">
        <div class="grid-content bg-purple-light">
          <el-form ref="formResult" :model="formResult" label-width="180px">
            ...
            <el-form-item label="">
              <el-col :span="6" class="focus-info">第二次买入:</el-col>
            </el-form-item>
            <el-form-item label="">
              <el-col :span="6">买入手续费</el-col>
              <el-col :span="6">{{ formResult.buyCharge2 }} </el-col>
              <el-col :span="6">买入过户费</el-col>
              <el-col :span="6">{{ formResult.buyTransferFee2 }} </el-col>
            </el-form-item>
            <el-form-item label="">
              <el-col :span="6">买入通讯费</el-col>
              <el-col :span="6">{{ formResult.buyCommunications2 }} </el-col>
              <el-col :span="6">买入金额:</el-col>
              <el-col :span="6">{{ formResult.dealMoney2 }} </el-col>
            </el-form-item>
            <el-form-item label="">
              <el-col :span="6">总的买入手续费</el-col>
              <el-col :span="6" class="focus-info">{{ formResult.totalBuyCharge2 }} </el-col>
              <el-col :span="6">总的买入费用合计:</el-col>
...
export default {
  ...
  methods: {
    ...
    // 计算并展示结果
    calcAndShowResult() {
      toolApi.coverMoney(this.form).then(
        response => {
          ...
          this.formResult.buyCharge2 = calcBuyMoneyVoList[1].buyCharge
          this.formResult.buyTransferFee2 = calcBuyMoneyVoList[1].buyTransferFee
          this.formResult.buyCommunications2 = calcBuyMoneyVoList[1].buyCommunications
          this.formResult.dealMoney2 = calcBuyMoneyVoList[1].dealMoney
          this.formResult.totalBuyCharge2 = calcBuyMoneyVoList[1].totalBuyCharge
          this.formResult.totalBuyCharge = response.data.totalBuyCharge
